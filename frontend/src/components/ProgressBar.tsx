...
export function ProgressBar({ value, label }: Props) {
  ...
  return (
    <div className="w-full">
      {label ? <div className="mb-2 flex items-center justify-between text-xs font-semibold text-ink-700">{label}</div> : null}
      <div className="h-2.5 w-full overflow-hidden rounded-full bg-white/70 ring-1 ring-slate-200/70">
