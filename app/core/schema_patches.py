...
def apply_postgres_patches(engine: Engine) -> None:
    ...
    with engine.begin() as conn:
        ...
        conn.execute(text("CREATE INDEX IF NOT EXISTS ix_universities_name ON universities (name)"))
        conn.execute(text("CREATE INDEX IF NOT EXISTS ix_universities_city ON universities (city)"))
        conn.execute(text("CREATE INDEX IF NOT EXISTS ix_universities_district ON universities (district)"))
        conn.execute(text("CREATE INDEX IF NOT EXISTS ix_faculties_code ON faculties (code)"))
        conn.execute(text("CREATE INDEX IF NOT EXISTS ix_faculties_name ON faculties (name)"))
        conn.execute(text("CREATE INDEX IF NOT EXISTS ix_specialties_code ON specialties (code)"))
        conn.execute(text("CREATE INDEX IF NOT EXISTS ix_specialties_name ON specialties (name)"))
        conn.execute(text("CREATE INDEX IF NOT EXISTS ix_specialties_language ON specialties (language)"))
        conn.execute(text("CREATE INDEX IF NOT EXISTS ix_specialties_study_mode ON specialties (study_mode)"))
        conn.execute(text("CREATE INDEX IF NOT EXISTS ix_specialties_tuition ON specialties (tuition)"))
        conn.execute(text("CREATE INDEX IF NOT EXISTS ix_specialties_degree ON specialties (degree)"))
